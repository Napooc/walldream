            ...
            >
              <div className="relative overflow-hidden rounded-3xl bg-card shadow-xl hover:shadow-2xl transition-all duration-500">
                ...
                <div className="relative z-20 p-8">
                  ...
                  {/* Decorative element */}
                  <motion.div
                    className="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-secondary to-accent transform origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-500"
                    initial={{ scaleX: 0 }}
