  ...
  return <section ref={heroRef} className="relative min-h-screen overflow-hidden" id="home">
      ...
      y
        ...
        <AnimatePresence mode="wait">
          <motion.div key={currentImage} initial={{
          opacity: 0,
          scale: 1.2
        }} animate={{
          opacity: 1,
          ...
          ease: [0.43, 0.13, 0.23, 0.96]
            ...
            <img src={heroImages[currentImage].src} alt={heroImages[currentImage].alt} className="w-full h-full object-cover" />
          </motion.div>
        </AnimatePresence>
      </motion.div>
      ...
      <motion.div style={{
      opacity
    }} className="relative z-20 min-h-screen flex items-center pt-24 pb-12">
