...
export const FooterTapedDesign = () => {
  ...
  return (
    <footer className="my-8 px-4 max-w-5xl text-base-content mx-auto">
      <div className="relative bg-white rounded-3xl max-w-5xl mx-auto px-4 py-10 flex flex-col md:flex-row justify-between items-center gap-6 shadow-xl border border-border/20">
        ...
        <div className="flex flex-col md:flex-row items-start justify-between gap-4 md:gap-10 px-2 md:px-8 flex-1 w-full">
          <div className='flex flex-col items-start gap-2'>
            <a
              ...
              className="flex flex-row gap-2 items-center justify-start text-2xl font-display font-extrabold text-primary hover:opacity-80 transition-opacity"
            >
              <img src={logo} alt="Wall Dream Logo" className="w-10 h-10 rounded-full" />
              Wall Dream
            </a>
            <p className='text-muted-foreground font-medium text-base w-full md:w-4/5'>
              L'impression murale professionnelle nouvelle génération. Transformez vos espaces avec notre technologie robotisée de pointe.
            </p>
          </div>

          <div className='flex flex-col md:mx-4 md:flex-row gap-6 md:gap-12 items-start md:items-start'>
            <div className='flex flex-col gap-1 md:gap-4'>
              <h4 className='uppercase font-display text-sm text-muted-foreground font-semibold'>Services</h4>
              <div className="flex flex-wrap md:flex-col gap-2 text-sm text-foreground items-start">
                <a 
                  ...
                  className='text-muted-foreground whitespace-nowrap font-medium hover:text-secondary transition-colors'
                >
                  Impression murale
                </a>
                <a 
            ...
            <div className='flex flex-col gap-1 md:gap-4'>
              <h4 className='uppercase whitespace-nowrap font-display text-sm text-muted-foreground font-semibold'>Entreprise</h4>
      ...
      <div className="my-3 px-4 md:px-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 text-sm text-foreground">
